...
#
# Adapted from tue-mps/EoMT, used under the MIT License.
...
class MaskClassificationLoss(Mask2FormerLoss):
    def __init__(
        ...
        sim_coefficient: float,
        cons_coefficient: float,
        num_labels: int,
        ...
        self.cons_coefficient = cons_coefficient
    ...
    def loss_total(self, losses_all_layers, log_fn) -> torch.Tensor:
        ...
        for loss_key, loss in losses_all_layers.items():
            ...
            elif "similarity" in loss_key:
                weighted_loss = loss * self.sim_coefficient
            elif "consistency" in loss_key:
                weighted_loss = loss * self.cons_coefficient
            else:
