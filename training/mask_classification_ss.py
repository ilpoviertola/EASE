...
class MaskClassificationSS(LightningModule):
    def __init__(
        self,
        network: nn.Module,
    ...
    def on_validation_epoch_end(self):
        self._on_eval_epoch_end_s4_ms3_ss(
            "val", is_ss=(not self.network.collapse_to_binary_logits)
        )
    ...
    def on_test_epoch_end(self):
        self._on_eval_epoch_end_s4_ms3_ss(
            "test", is_ss=(not self.network.collapse_to_binary_logits)
        )
